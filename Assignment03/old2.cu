...
class Polygon {
    public:
        thrust::host_vector<Point> vertices;
        thrust::host_vector<Line> edges;

        __host__ __device__
        Polygon(const thrust::host_vector<Point>& v, const thrust::host_vector<Line>& e) {
            vertices = v;
            edges = e;
        }
};
...
class Graph {
    public:
        Point start;
        Point end;
        thrust::host_vector<Polygon> polygons;
        ...
        void readGraph(std::string filepath) {
            ...
            thrust::host_vector<Point> polygonVertices;
            thrust::host_vector<Line> polygonEdges;
...
class VisibilityGraph {
    public:
        ...
        thrust::host_vector<bool> concaveCorners;
        bool cpu;

        __host__ __device__
        VisibilityGraph(bool value) : cpu(value) {}
